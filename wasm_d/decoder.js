...
var _destroy = (Module['_destroy'] = function () {
    return (_destroy = Module['_destroy'] = Module['asm']['q']).apply(null, arguments);
});
...
var _decode = (Module['_decode'] = function () {
    return (_decode = Module['_decode'] = Module['asm']['t']).apply(null, arguments);
});
...
var _ff_h264_cabac_tables = (Module['_ff_h264_cabac_tables'] = 33189);
var calledRun;
