...
var wasmBinaryFile = 'capture.wasm';
...
var _setFile = (Module['_setFile'] = function () {
    return (_setFile = Module['_setFile'] = Module['asm']['F']).apply(null, arguments);
});
var _capture = (Module['_capture'] = function () {
    return (_capture = Module['_capture'] = Module['asm']['G']).apply(null, arguments);
});
